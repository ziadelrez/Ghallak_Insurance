...
function fetch_customer_data(clientid=$("#clientid").val())
{
     var table = $('#bootstrap-data-table').DataTable({
        ...
        columns: [
            ...
            {data: 'maid_dob', name: 'maid_dob'},
            {data: 'maid_natio', name: 'maid_natio'},
            {data: 'maid_passport', name: 'maid_passport'},
            {data: 'maid_action', name: 'action', orderable: false, searchable: false}
        ]
    });
}
