...
<body>
    ...
    <header class="mb-3"  style="right: -200px; margin-right: 300px;" >
        <button class="burger-btn d-block d-xl-none"  id="sidebutton" >
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8 col-md-12">
                            <form action="agents_reports_inter.php" method="post">
                                <div class="form-group">
                                    <label for="agent">الإسم</label>
            ...
            <script src="assets/js/search7.js"></script>  <!-- jQuery CDN - Slim version (=without AJAX) -->
