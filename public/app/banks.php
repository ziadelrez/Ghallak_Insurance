                ...
                <div class="card-body">
                    <div class="row">
                        <table>
                            <div class="col-lg-8 col-md-12">
                                <form action="add_bank_inter.php" method="post">
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="bank" name="bank" placeholder=" إسم البنك">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="buttons">
                                                <button type="submit" name="submit6" class="btn btn-primary"> إضافة البنك</button>
                                            </div>
                                        </td>
                                    </tr>
                    ...
                    <div class="container-table100">
                        ...
                        for ($i = 0; $i < mysqli_num_rows($res); $i++) {
                            ...
                            echo "<tr class='row2'>";
                            echo "<td class='cell'>" . $row['bank_name'] . "</td>";
                            echo "</tr>";
                        } ?>
                        </table>
                    </div>
