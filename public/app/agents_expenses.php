        ...
        <button class="burger-btn d-block d-xl-none"  id="sidebutton" >
                        ...
                        <div class="col-lg-8 col-md-12">
                            <form action="" method="post">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="search7" name="search7" placeholder="بحث">
                                </div>
                                <!-- <input type="submit" name="btn" id="btn" style="display: none;" autofocus> -->
                            </form>
                            <div class="list-group list-group-item-action" id="content7"></div>
            ...
            <div class="page-content" style="left: -300px; margin-right: 300px;">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8 col-md-12">
                            <form action="add_agent_exp_inter.php" method="post">
                                <div class="form-group">
                                ...
                                <script>
                                    function search_agent(e) {
                                        ...
                                        document.getElementById("agent").value = e.target.innerHTML;
                                        $('#agent_content').html('');
                                        var someVarName1 = document.getElementById("agent").value;
                                        localStorage.setItem("someVarKey1", someVarName1);
                                        var person = document.getElementById("agent").value;
                                        location.href = "agents_expenses.php?agent=" + person;
                                    }

                                    var s1 = localStorage.getItem("someVarKey1");

                                    document.getElementById("agent").value = s1;
                                    console.log(s1);
                                ...
                                if (!isset($_GET['agent'])) {
                                    ...
                                    $sql4 = "SELECT * FROM contract WHERE agent = '" . $row3['person_id'] . "'";
                                    $resultat4 = mysqli_query($con, $sql4);
                                    for ($i = 0; $i < mysqli_num_rows($resultat4); $i++) {
                                        $row4 = mysqli_fetch_array($resultat4);
                                        $total += $row4['agent_portion'];
                                    }
                                    $sql5 = "SELECT * FROM agent_expenses WHERE agent_id = '" . $row3['person_id'] . "'";
                                            ...
                                            <table class="table table-striped table-hover" id="table2">
                                                ...
                                                <tbody id="contract_table">
                                                    ...
                                                    if ($person != null  && $contract == null) {
                                                        $sql8 = "SELECT * FROM contract WHERE agent = '" . $row3['person_id'] . "'";
                                ...
                                <script>
                                    function refresh() {
                                        ...
                                        location.href = "agents_expenses.php?agent=" + person + "&contract=" + select;
                                    }
                                    ...
                                    function myFunction() {
                                        ...
                                        var rows = document.querySelector("#table2").rows;
                                ...
                                if ($contract != NULL) {
                                    ...
                                    $sql6 = "SELECT * FROM contract WHERE contract_number = '$contract'";
                                    $res6 = mysqli_query($con, $sql6);
                                    $row6 = mysqli_fetch_array($res6);
                                    $sql7 = "SELECT * FROM agent_expenses WHERE contract_id = '".$row6['contract_id']."' AND agent_id='" . $row3['person_id'] . "'";
                                    ...
                                    } else $rest = $row6['agent_portion'];
                                } else $rest = 0;

                                //$rest = $row5['agent_portion'];
                                ?>
                                <div class="form-group">
                ...
                <div class="buttons">
                    <button type="submit" name="submit" onclick="subfunc2()" class="btn btn-primary"> إضافة دفعة</button>
                </div>
                </form>
                <script>
                    function subfunc2() {
