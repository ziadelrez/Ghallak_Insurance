<?php 
    require_once "connection.php";
        ...
        $query3 = "SELECT * FROM garage WHERE garage_name = '$person'";
        $resultat3 = mysqli_query($con, $query3);
        $row3 = mysqli_fetch_array($resultat3);
        
        $sql = "SELECT * FROM accident JOIN accident_cost ON accident.accident_id = accident_cost.accident_id AND garage_id = '".$row3['garage_id']."' 
