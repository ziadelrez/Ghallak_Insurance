        ...
        <button class="burger-btn d-block d-xl-none"  id="sidebutton" >
            ...
            <div class="page-content" style="left: -300px; margin-right: 300px;">
                <div class="card-body">
                        ...
                        <div class="wrap-table100">
                            <table class="table table-striped table-hover">
                                ...
                                for ($i = 0; $i < mysqli_num_rows($resultat4); $i++) {
                                    ...
                                    echo "<tr class='row2' onclick='agent_info(" . $row['agent_expenses_id'] . ")'>";
                                    echo "<td><input type='checkbox' onclick='GetSelected(event, " . $row['agent_expenses_id'] . ", " . $row['required_amount'] . ", " . $row['lebanese_amount'] . ", \"" . $row1['contract_number'] . "\")'></td>";
                    ...
                    <br>
                    <div class="buttons">
                        <button type="submit" name="submit" onclick="wasel1()" formtarget="_blank" class="btn btn-primary"> الإيصال</button>
                    </div>
                </div>
            </div>
            <br>
            ...
            <script>
                ...
                var cont = new Set(arr);
                    ...
                    var location = "agent_receipt.php?agent=" + person + "&somme=" + amount + "&contracts=" + [...cont].join(" - ") + "&lebanese=" + lebanese;
                    window.open(location, '_blank');
                }
            </script>
            <?php
            $sql2 = "SELECT * FROM contract WHERE agent= '" . $row3['person_id'] . "'";
            $res2 = mysqli_query($con, $sql2);
            if (mysqli_num_rows($res2)!=0) {
                for ($i = 0; $i < mysqli_num_rows($res2); $i++) {
                    $row2 = mysqli_fetch_array($res2);
                    global $total_amount;
                    $total_amount += $row2['agent_portion'];
                }
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                for ($i = 0; $i < mysqli_num_rows($resultat4); $i++) {
                                    ...
                                    if (strtotime($row5['next_paydate']) > strtotime($now)) {
                                        echo "<tr class='row2' onclick='ex(" . $row5['agent_expenses_id'] . ")'>";
                ...
                <div class="card-body">
                    ...
                    <script type="text/javascript">
                        function agent_info(id) {
                            location.href = "edit_agent_expenses.php?agent_expenses_id=" + id;
                        };
                    </script>
