...
<body>
    ...
    <header class="mb-3"  style="right: -200px; margin-right: 300px;" >
        <button class="burger-btn d-block d-xl-none"  id="sidebutton" >
            ...
            <?php 
            $other = $_GET['other_expenses_id'];
            $sql = "SELECT * FROM other_expenses WHERE other_expenses_id='$other'";
            ...
            <div class="page-content" style="left: -300px; margin-right: 300px; ">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8 col-md-12">
                            <form action="edit_other_exp_inter.php?other_expenses_id=<?php echo $other;?>" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="total" name="total"  value="<?php echo $row['amount']; ?>"required>
                                </div>
                ...
                <div class="buttons">
                    ...
                    <a href = "other_expenses.php" name="back" class="btn btn-danger"> رجوع </a>
                    <a href="delete_other_expenses.php?other_expenses_id=<?php echo $other; ?>" class="btn btn-danger" id="delete_btn" onclick="return confirm('هل أنت متأكد ؟')">حذف الدفعة </a>
                </div>
                </form>
