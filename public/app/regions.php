                    ...
                    <div class="row">
                        <table>
                            <div class="col-lg-8 col-md-12">
                                <form action="add_region_inter.php" method="post">
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="region" name="region" placeholder="إسم المنطقة">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="buttons">
                                                <button type="submit" name="submit5" class="btn btn-primary"> إضافة المنطقة</button>
                                            </div>
                                        </td>
                                    </tr>
