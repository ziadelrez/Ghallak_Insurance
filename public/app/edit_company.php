                    ...
                    <div class="row">
                        <!-- <table> -->
                            <div class="col-lg-8 col-md-12">
                                ...
                                <form action="edit_company_inter.php?company_id=<?php echo $id;?>" method="post" >
                                    <div class="form-group">
                                        <label for="company">إسم الشركة</label>
                                        <input type="text" class="form-control" id="company" name="company" value="<?php echo $row['company_name'];?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="web" name="web" value="<?php echo $row['website'];?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="home">الهاتف الأرضي</label>
                                        <input type="text" class="form-control" id="home" name="home" value="<?php echo $row['number'];?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <br>
                                    <div class="buttons">
                                        <button type="submit" name="submit" class="btn btn-primary"> تعديل الشركة</button>
                                        <a href="companies.php" class="btn btn-danger"> رجوع</a>
                                        <a href="delete_company.php?company_id=<?php echo $id;?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this company')" id="delete_btn">حذف الشركة </a>
