    ...
    <header class="mb-3"  style="right: -200px; margin-right: 300px;" >
        <button class="burger-btn d-block d-xl-none"  id="sidebutton" >
            ...
            <div class="page-content" style="left: -300px; margin-right: 300px;">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8 col-md-12">
                            <form action="add_other_exp_inter.php" method="post">
                                <div class="form-group">
                                    <label for="desc">سبب الدفعة* </label>
                                    <input type="text" class="form-control" id="desc" name="desc" required>
                                </div>

                                <div class="form-group">
                                    <label for="total"> قيمة الدفعة بالدولار*</label>
                ...
                <div class="buttons">
                    <button type="submit" name="submit" class="btn btn-primary"> إضافة دفعة</button>
                </div>
                </form>
                ...
                <div class="card-body">
                        ...
                        <div class="wrap-table100">
                            <table class="table table-striped table-hover">
                                <tr class="row2 header">
                                    <th class="cell"> سبب الدفعة</th>
                                    <th class="cell"> قيمة الدفعة</th>
                                    <th class="cell"> تاريخ الدفعة</th>
                                    <th class="cell"> رقم الحوالة المصرفية</th>
                                </tr>
                                <?php
                                for ($i = 0; $i < mysqli_num_rows($r); $i++) {
                                    $roww = mysqli_fetch_array($r);

                                    echo "<tr class='row2' onClick='other_info(" . $roww['other_expenses_id'] . ")'>";
                                    echo "<td data-title='سبب الدفعة'>" . $roww['description'] . "</td>";
                                    echo "<td data-title='قيمة الدفعة'>" . $roww['amount'] . "</td>";
                                    echo "<td data-title='تاريخ الدفعة'>" . $roww['payday'] . "</td>";
                                    echo "<td data-title='رقم الحوالة المصرفية'" . $roww['check_number'] . "</td>";
                                    echo "</tr>";
                                } ?>
                            </table>
                        </div>
                    ...
                    <script type="text/javascript">
                        function other_info(id) {
                            location.href = "edit_other_expenses.php?other_expenses_id=" + id;
                        };
                    </script>
