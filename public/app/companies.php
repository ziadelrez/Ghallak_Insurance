        ...
        <button class="burger-btn d-block d-xl-none"  id="sidebutton" >
            ...
            <div class="page-content" style="left: -300px; margin-right: 300px; ">
                        ...
                        <!-- <table> -->
                            <div class="col-lg-8 col-md-12">
                                <!-- <form action="add_garage_inter.php" method="post"> -->
                                    <!-- <tr>
                                        <td> -->
                                        <form action="add_company_inter.php" method="post" >
                                            ...
                                            <div class="form-group">
                                                <label for="web">الموقع الإلكتروني</label>
                                            ...
                                            <div class="form-group">
                                                <label for="region">المنطقة :</label>
                                                    <select name="region" class="btn btn-light dropdown-toggle dropdown-toggle-split" style="width:200px;" id="region">
                                                    <?php 
                                                        $sql1 = "SELECT * FROM regions";
                                                        $result1 = mysqli_query($con, $sql1);
                                                        for($i=0; $i<mysqli_num_rows($result1); $i++){
                                                                $rr = mysqli_fetch_array($result1);
                                                                echo "<option class='dropdown-item' value=".$rr['region_id'].">".$rr['name']."</option>";
                                                            }
                                                            ?>
                                                    </select>
                                            </div>
                                        ...
                                        <td> -->
                                            <div class="buttons">
                                                <button type="submit" name="submit8" class="btn btn-primary"> إضافة الشركة</button>
                                            </div>
                                        <!-- </td>
                                    </tr> -->
                ...
                <div class="container-table100">
                    <div class="wrap-table100">
                        <table class="table table-striped table-hover">
                             ...
                             <th class="cell"> إسم الشركة</th>
                             <th class="cell"> الهاتف الأرضي</th>
                             <th class="cell">الفاكس</th>
                            </tr>
                            <?php 
                            for ($i=0; $i< mysqli_num_rows($res); $i++) {
                            $row = mysqli_fetch_array($res); 
                            echo "<tr class='row2' onclick='gooo(".$row['company_id'].")'>";
                            echo "<td data-title='إسم الشركة'>".$row['company_name']."</td>";
                            echo "<td data-title='الهاتف الأرضي'>".$row['number']."</td>";
                            echo "<td data-title='الفاكس'>".$row['fax']."</td>";
                            echo "</tr>";
                            } ?>
                        </table>
                    </div>
             ...
             <script type="text/javascript">
                    function gooo(id) {
                        location.href = "edit_company.php?company_id="+id;
                    };
                </script>
    </div>
