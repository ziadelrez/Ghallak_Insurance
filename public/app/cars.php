                    ...
                    <div class="row">
                        <table>
                            <div class="col-lg-8 col-md-12">
                                <form action="add_car_inter.php" method="post">
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="car" name="car" placeholder="إسم السيارة">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="buttons">
                                                <button type="submit" name="submit3" class="btn btn-primary"> إضافة السيارة</button>
                                            </div>
                                        </td>
                                    </tr>
                ...
                <div class="container-table100">
                    <div class="wrap-table100">
                         <table class="table table-striped table-hover">
                            ...
                            echo "<tr class='row2'>";
                            echo "<th class='cell'>".$row['name']."</th>";
                            echo "</tr>";
                            } ?>
                        </table>
                    </div>
