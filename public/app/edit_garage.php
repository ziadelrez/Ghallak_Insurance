...
<body>
   ...
   <div class="wrapper">
    ...
    $id = $_GET['garage_id'];
    $sql = "SELECT * FROM garage WHERE garage_id ='$id'";
                        ...
                        <!-- <table> -->
                            <div class="col-lg-8 col-md-12">
                                <!-- <form action="add_garage_inter.php" method="post"> -->
                                    <!-- <tr>
                                        <td> -->
                                        <form action="edit_garage_inter.php?garage_id=<?php echo $id;?>" method="post" >
                                            <div class="form-group">
                                                <label for="garage">إسم الغراج</label>
                                                <input type="text" class="form-control" id="garage" name="garage" value="<?php echo $row['garage_name'];?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="address">العنوان</label>
                                                <input type="text" class="form-control" id="address" name="address" value="<?php echo $row['location'];?>">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="home" name="home" value="<?php echo $row['home_number'];?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="owner">إسم المالك</label>
                                                <input type="text" class="form-control" id="owner" name="owner" value="<?php echo $row['owner_name'];?>">
                                            </div>
                                        ...
                                        <td> -->
                                            <br>
                                            <div class="buttons">
                                                <button type="submit" name="submit7" class="btn btn-primary"> تعديل الغراج</button>
                                                <a href="garages.php" class="btn btn-danger"> رجوع</a>
                                                <a href="delete_garage.php?garage_id=<?php echo $id;?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this garage')" id="delete_btn">حذف الغراج </a>
