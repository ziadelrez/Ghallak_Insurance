        ...
        <button class="burger-btn d-block d-xl-none"  id="sidebutton" >
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-12">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" id="expert_search" name="expert_search" placeholder="بحث">
                            </div>
                            <!-- <input type="submit" name="btn" id="btn" style="display: none;" autofocus> -->
                           </form>
                           <div class="list-group list-group-item-action" id="expert_content"></div>
            ...
            <div class="page-content" style="left: -300px; margin-right: 300px; ">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8 col-md-12">
                            <form action="add_expert_exp_inter.php" method="post" >
                            <div class="form-group">
                                <label for="expert">الخبير*</label>
                                <input type="text" class="form-control" id="expert" name="expert" required>
                                <div class="list-group list-group-item-action" id="contentsss"></div>
                            </div>
                            <script>
                                function search_expert(e) {
                                
                                document.getElementById("expert").value = e.target.innerHTML;
                                $('#contentsss').html('');
                                var someVarName2 =  document.getElementById("expert").value;
                                localStorage.setItem("someVarKey2", someVarName2);
                                var person = document.getElementById("expert").value;
                                location.href="experts_expenses.php?expert="+person;
                                } 

                                var s2 = localStorage.getItem("someVarKey2");
                                
                                document.getElementById("expert").value = s2;
                                console.log(s2);
                             ...
                             <?php
                                    ...
                                    if(!isset($_GET['expert'])){
                                        ...
                                        $sql4 = "SELECT * FROM accident_cost WHERE expert_id = '".$row3['person_id']."'";
                                        $resultat4 = mysqli_query($con, $sql4);
                                        for ($i=0; $i<mysqli_num_rows($resultat4); $i++) {
                                            $row4 = mysqli_fetch_array($resultat4);
                                            $total += $row4['cost'];
                                        }
                                        $sql5 = "SELECT * FROM expert_expenses WHERE expert_id = '".$row3['person_id']."'";
                                        ...
                                        <div class="wrap-table100">
                                            <table class="table table-striped table-hover" id="table1">
                                                ...
                                                <tbody id="accident_table">
                                                    <?php
                                                    if ($person != null && $accident_id == null) {
                                                        $sql8 = "SELECT * FROM accident JOIN accident_cost ON accident.accident_id = accident_cost.accident_id AND accident_cost.expert_id = '".$row3['person_id']."'";
                            ...
                            function refresh1(){
                                ...
                                location.href="experts_expenses.php?expert="+person+"&accident_id="+select;
                            }
                            ...
                            <div class="form-group">
                                ...
                                <select name="accident_cost" class="btn btn-light dropdown-toggle dropdown-toggle-split" onchange="refresh2()" id="accident_cost" required>
                                   ...
                                   $sql6 = "SELECT * FROM accident_cost WHERE accident_id = '$accident_id' AND expert_id='".$row3['person_id']."'";
                                   ...
                                   echo "<option class='dropdown-item' value=0>NOT SELECTED</option>";
                                    for ($i=0; $i<mysqli_num_rows($resultat6); $i++) {
                                        ...
                                        if($accident_cost==$row6['accident_cost_id']){
                                            echo "<option class='dropdown-item' value=".$row6['accident_cost_id']." selected>".$row6['cost']." | ".$row4['date']."</option>";
                                        }
                                        else echo "<option class='dropdown-item' value=".$row6['accident_cost_id'].">".$row6['cost']." | ".$row4['date']."</option>";
                                    }
                                    ?>
                            ...
                            function refresh2(){
                                ...
                                location.href="experts_expenses.php?expert="+person+"&accident_id="+select+"&accident_cost="+acc_cost;
                            }
                            </script>
                            <?php
                            if($accident_cost!=null){
                                ...
                                $sql7 = "SELECT * FROM expert_expenses WHERE accident_cost_id = '$accident_cost'";
                ...
                <script>
                        function subfunc3(){
                            localStorage.removeItem("someVarKey2");
                            console.log("remved");
                        }
                    </script>
                   </div>
