    ...
    <header class="mb-3"  style="right: -200px; margin-right: 300px;" >
        <button class="burger-btn d-block d-xl-none"  id="sidebutton" >
            ...
            <div class="page-heading" style="right: -200px; margin-right: 300px;">
                <h3>تقارير الخبراء</h3>
            </div>
            <div class="page-content" style="left: -300px; margin-right: 300px; ">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8 col-md-12">
                            <form action="experts_reports_inter.php" method="post">
                                <div class="form-group">
                                    <label for="expert">الإسم</label>
                                ...
                                <br>
                                <div class="buttons">
                                    <button type="submit" name="submit" formtarget="_blank" class="btn btn-primary">إصدار التقارير</button>
                                </div>
                            </form>
                            <script>
