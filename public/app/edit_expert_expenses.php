...
$sql = "SELECT * FROM expert_expenses WHERE expert_expenses_id = '$id'";
$res = mysqli_query($con, $sql);
$row = mysqli_fetch_array($res);
$sql1 = "SELECT * FROM person WHERE person_id = '" . $row['expert_id'] . "'";
...
if (!isset($_GET['accident_id'])) {
    ...
    $sql7 = "SELECT * FROM expert_expenses WHERE accident_cost_id = '" . $row['accident_cost_id'] . "'";
    ...
    if ($accident_cost == $row['accident_cost_id'] && $accident == $row['accident_id']) {
        header("Location: edit_expert_expenses.php?expert_expenses_id=" . $id);
    }
}
?>
<!DOCTYPE html>
        ...
        <button class="burger-btn d-block d-xl-none"  id="sidebutton" >
            ...
            <div class="page-content" style="left: -300px; margin-right: 300px;">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8 col-md-12">
                            <form action="edit_expert_exp_inter.php?expert_expenses_id=<?php echo $id; ?>" method="post">
                                <div class="form-group">
                                    <label for="expert">الخبير*</label>
                                    <input type="text" class="form-control" id="expert" name="expert" value="<?php echo $row1['person_name']; ?>" readonly>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="accident" class="btn btn-light dropdown-toggle dropdown-toggle-split" onchange="refresh1()" id="accident" required>
                                        ...
                                        <?php
                                        $sql4 = "SELECT * FROM accident JOIN accident_cost ON accident.accident_id = accident_cost.accident_id 
                                   AND accident_cost.expert_id = '" . $row['expert_id'] . "'";
                                ...
                                <script>
                                    function refresh1() {
                                        ...
                                        location.href = "edit_expert_expenses.php?expert_expenses_id=" + person + "&accident_id=" + select;
                                    }
                                </script>
                                <div class="form-group">
                                    ...
                                    <select name="accident_cost" class="btn btn-light dropdown-toggle dropdown-toggle-split" onchange="refresh2()" id="accident_cost" required>
                                        ...
                                        if ($accident == null) {
                                            $sql5 = "SELECT * FROM accident_cost WHERE accident_id = '" . $row['accident_id'] . "' AND expert_id='" . $row['expert_id'] . "'";
                                            ...
                                            $sql6 = "SELECT * FROM accident_cost WHERE accident_id = '$accident' AND expert_id='" . $row['expert_id'] . "'";
                                ...
                                <script>
                                    function refresh2() {
                                        ...
                                        var select = acc.value;
                                        location.href = "edit_expert_expenses.php?expert_expenses_id=" + person + "&accident_id=" + select1 + "&accident_cost=" + select;
                                    }
                                </script>
                                <div class="form-group">
                ...
                <div class="buttons">
                    ...
                    <a href="experts_expenses.php" name="back" class="btn btn-danger"> رجوع </a>
                    <a href="delete_expert_expenses.php?expert_expenses_id=<?php echo $id; ?>" class="btn btn-danger" id="delete_btn" onclick="return confirm('هل أنت متأكد ؟')">حذف الدفعة </a>
                </div>
                </form>
