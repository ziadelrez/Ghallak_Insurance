    ...
    <header class="mb-3"  style="right: -200px; margin-right: 300px;" >
        <button class="burger-btn d-block d-xl-none"  id="sidebutton" >
            ...
            <div class="page-heading" style="right: -200px; margin-right: 300px;">
                <h3>إضافة وجهة إستعمال السيارة </h3>
            </div>
                    ...
                    <div class="row">
                        <table>
                            <div class="col-lg-8 col-md-12">
                                <form action="add_car_type_inter.php" method="post">
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="car_type" name="car_type" placeholder="وجهة إستعمال السيارة ">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="buttons">
                                                <button type="submit" name="submit4" class="btn btn-primary"> إضافة الوجهة</button>
                                            </div>
                                        </td>
                                    </tr>
                    ...
                    <div class="wrap-table100">
                        <table class="table table-striped table-hover">
                             <tr class="row2 header">
                                 <th class="cell"> وجهات السيارات</th>
                            </tr>
                         </div>
                            <?php 
