...
$sql2 = "SELECT * FROM expert_expenses WHERE expert_id = '" . $row1['person_id'] . "' AND (date BETWEEN '$start' AND '$end')";
...
$sql6 = "SELECT * FROM accident_cost JOIN accident ON accident_cost.accident_id=accident.accident_id AND accident_cost.expert_id= '" . $row1['person_id'] . "' AND (accident.date BETWEEN '$start' AND '$end')";
