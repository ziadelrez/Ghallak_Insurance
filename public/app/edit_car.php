...
<body>
    ...
    $car_num = $_GET['car_number'];
    $query = "SELECT * FROM car WHERE car_number = '$car_num'";
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8 col-md-12">
                            <form action="edit_car_inter.php?person_id=<?php echo $row['person_id'];?>&car_id=<?php echo $row['car_id'];?>" method="post" >
                            <div class="form-group">
                                <label for="number">رقم السيارة</label>
                                <input type="text" class="form-control" id="number" name="number" value="<?php echo $car_num;?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="style" name="style" value="<?php echo $row['style'];?>">
                            </div>
                            <div class="form-group">
                                <label for="chassis">رقم الشيسي</label>
                                <input type="text" class="form-control" id="chassis" name="chassis" value="<?php echo $row['VIN'];?>">
                            </div>
                            <div class="form-group">
                                <label for="engine">رقم المحرك</label>
                                <input type="text" class="form-control" id="engine" name="engine" value="<?php echo $row['engine_number'];?>">
                            </div>
                            <div class="form-group">
                                <label for="power">قوة المحرك</label>
                                <input type="text" class="form-control" id="power" name="power" value="<?php echo $row['engine_power'];?>">
                            </div>
                            <div class="form-group">
                            ...
                            <label for="name">ماركة السيارة :</label>
                                ...
                                <?php for($i=0; $i<mysqli_num_rows($result2); $i++){
                                        ...
                                        if($row['car_name_id']==$rr['car_name_id']){
                                            echo "<option class='dropdown-item' value=".$rr['car_name_id']." selected>".$rr['name']."</option>";
                                        }else echo "<option class='dropdown-item' value=".$rr['car_name_id'].">".$rr['name']."</option>";
                                    }
                                    ?>
                                </select>
                            </div>
                            ...
                            <label for="type">وجهة إستعمال السيارة :</label>
                                ...
                                <?php for($i=0; $i<mysqli_num_rows($result3); $i++){
                                        ...
                                        if($row['car_type_id']==$rrr['car_type_id']){
                                            echo "<option class='dropdown-item' value=".$rrr['car_type_id']." selected>".$rrr['name']."</option>";
                                        }else echo "<option class='dropdown-item' value=".$rrr['car_type_id'].">".$rrr['name']."</option>";
                                    }
                                    ?>
                                </select>
                            </div>
                   ...
                   <br>
                    ...
                    <div class="buttons">
                  <button type="submit" name="submit" class="btn btn-primary"> تعديل السيارة</button>
                  <a href="person.php" class="btn btn-danger"> رجوع</a>
                  <?php 
                    $sql5="SELECT * FROM contract WHERE car_id = '".$row['car_id']."'";
                    $res5 = mysqli_query($con, $sql5);
                    $sql6="SELECT * FROM accident_cost WHERE car_id = '".$row['car_id']."'";
                    $res6=mysqli_query($con, $sql6);
                    if (mysqli_num_rows($res5)!=0 || mysqli_num_rows($res6)!=0) { ?>
                        <a class="btn btn-danger" onclick="mssg()" style="margin-right: 210px;">حذف السيارة </a>
                        <script>
                        function mssg(){
                            alert("لا يمكنك حذف هذه السيارة");
                        }
                        </script>
                    ...
                    <?php 
                        ...
                        <a href="delete_car.php?car=<?php echo $row['car_id']; ?>" class="btn btn-danger" onclick="return confirm('هل أنت متأكد ؟')" style="margin-right: 210px;">حذف السيارة </a>
                    <?php }
                ?>
