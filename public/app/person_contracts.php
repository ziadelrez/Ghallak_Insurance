    ...
    <div class="container">
            ...
            <div class="page-content" style="left: -300px; margin-right: 300px; ">
                <div class="card-body">
                    ...
                    $sql1 = "SELECT * FROM contract WHERE person_id = '" . $row['person_id'] . "' ORDER BY start_date DESC";
                        ...
                        <div class="wrap-table100">
                            <table class="table table-striped table-hover">
                                ...
                                for ($i = 0; $i < mysqli_num_rows($res1); $i++) {
                                    ...
                                    $sql3 = "SELECT * FROM contract_type WHERE contract_type_id = '" . $row1['contract_type_id'] . "'";
                                    $res2 = mysqli_query($con, $sql3);
                                    $row2 = mysqli_fetch_array($res2);
                                    $sql4 = "SELECT * FROM car WHERE car_id = '".$row1['car_id']."'";
                                    $res4 = mysqli_query($con, $sql4);
                                    $row4 = mysqli_fetch_array($res4);
                                    echo "<tr class='row2' onclick='goooo(\"" . $row1['contract_number'] . "\")'>";
                                    echo "<td  data-title='رقم العقد'>" . $row1['contract_number'] . "</td>";
                                    echo "<td  data-title='نوع العقد'>" . $row2['type'] . "</td>";
                                    echo "<td  data-title='السيارة '>" . $row4['car_number'] . "</td>";
                                    echo "<td  data-title='تاريخ الإبتداء'>" . $row1['start_date'] . "</td>";
                                    echo "<td  data-title='تاريخ الإنتهاء'>" . $row1['end_date'] . "</td>";
                                    echo "</tr>";
                                } ?>
                            </table>
                        </div>
