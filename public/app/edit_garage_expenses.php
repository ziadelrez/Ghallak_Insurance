...
$sql = "SELECT * FROM garage_expenses WHERE garage_expenses_id = '$id'";
$res = mysqli_query($con, $sql);
$row = mysqli_fetch_array($res);
$sql1 = "SELECT * FROM garage WHERE garage_id = '" . $row['garage_id'] . "'";
...
if (!isset($_GET['accident_id'])) {
    ...
    if ($accident_cost == $row['accident_cost_id'] && $accident == $row['accident_id']) {
        header("Location: edit_garage_expenses.php?garage_expenses_id=" . $id);
    }
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <header class="mb-3"  style="right: -200px; margin-right: 300px;" >
        <button class="burger-btn d-block d-xl-none"  id="sidebutton" >
            ...
            <div class="page-content" style="left: -300px; margin-right: 300px; ">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8 col-md-12">
                            <form action="edit_garage_exp_inter.php?garage_expenses_id=<?php echo $id; ?>" method="post">
                                <div class="form-group">
                                    <label for="garage">الغراج*</label>
                                    <input type="text" class="form-control" id="garage" name="garage" value="<?php echo $row1['garage_name']; ?>" readonly>
                                    <div class="list-group list-group-item-action" id="contentss"></div>
                                </div>

                                <div class="form-group">
                                    <label for="accident">الحادث* :</label>
                                    <select name="accident" class="btn btn-light dropdown-toggle dropdown-toggle-split" onchange="refresh2()" id="accident" required>

                                        <?php
                                        $sql4 = "SELECT * FROM accident JOIN accident_cost ON accident.accident_id = accident_cost.accident_id AND
                                   accident_cost.garage_id = '" . $row['garage_id'] . "'";
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="accident_cost" class="btn btn-light dropdown-toggle dropdown-toggle-split" id="accident_cost"  onchange="refresh3()" required>

                                        <?php
                                         if ($accident == null) {
                                        $sql5 = "SELECT * FROM accident_cost WHERE accident_id = '" . $row['accident_id'] . "' AND garage_id='" . $row['garage_id'] . "'";
                                        ...
                                        $sql6 = "SELECT * FROM accident_cost WHERE accident_id = '$accident' AND garage_id='" . $row['garage_id'] . "'";
                                ...
                                <script>
                                    function refresh2() {
                                        ...
                                        location.href = "edit_garage_expenses.php?garage_expenses_id=" + person + "&accident_id=" + select;
                                    }
                                    ...
                                    function refresh3() {
                                        ...
                                        var select = acc.value;
                                        location.href = "edit_garage_expenses.php?garage_expenses_id=" + person + "&accident_id=" + select1 + "&accident_cost=" + select;
                                    }
                                </script>
                                <div class="form-group">
                ...
                <div class="buttons">
                    ...
                    <a href="garages_expenses.php" name="back" class="btn btn-danger"> رجوع </a>
                    <a href="delete_garage_expenses.php?garage_expenses_id=<?php echo $id; ?>" class="btn btn-danger" id="delete_btn" onclick="return confirm('هل أنت متأكد ؟')">حذف الدفعة </a>
                </div>
                </form>
        ...
        <script src="assets/js/main.js"></script><script src="https://code.jquery.com/jquery-3.3.1.slim.min.js" integrity="sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo" crossorigin="anonymous"></script>
    <!-- Popper.JS -->
