...
{{--        <span style="color:black">{{ trans('cruds.permission.add') }}</span>--}}
{{--        <br><br><h6><a href="{{ route("adminpanel.permissions.index") }}"><i class="fas fa-fast-backward"></i>  {{ trans('global.backtopermission') }}</a></h6>--}}
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ trans('cruds.permission.add') }}</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("adminpanel.permissions.store") }}" enctype="multipart/form-data">
            @csrf
