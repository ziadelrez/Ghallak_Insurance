...
{{--        {{ trans('global.create') }} {{ trans('cruds.role.title_singular') }}--}}
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ trans('cruds.role.btnadd') }}</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("adminpanel.roles.store") }}" enctype="multipart/form-data">
            @csrf
