...
@section('title')
    {{ trans('page-companies.menu.companies-list') }}
@endsection
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h5 class="m-0 font-weight-bold text-primary float-right">{{ trans('page-companies.pages.companies-list') }}</h5>
                    <div class="float-left">
                        <button class="create-modal btn btn-primary btn-lg" >
                            <i class="fas fa-plus-circle"></i>
                            {{ trans('page-companies.pages.buttons.btnadd') }}
                        </button>
                    </div>
                    @if (session('status'))
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="table" width="100%" cellspacing="0">
                            <thead>
                            <tr>
                                <th width="150px" style="display:none;" >{{ trans('page-companies.pages.tables.id') }}</th>
                                <th>{{ trans('page-companies.pages.tables.compname') }}</th>
                                @can('companies_actions')
                                    <th class="text-center" width="150px">{{ trans('page-companies.pages.tables.actions') }}</th>
                                @endcan
                                @can('instype_access')
                                    <th class="text-center" width="150px">{{ trans('page-companies.pages.tables.inslist') }}</th>
                                @endcan
                            </tr>
                            </thead>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="form" id="formcreate">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-4" for="compname">{{ trans('page-companies.pages.fields.compname') }} : </label>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-4" for="contactperson">{{ trans('page-companies.pages.fields.contactperson') }} : </label>
                        ...
                        {{--##Address Company--}}
                        <div class="form-group">
                            <label class="control-label col-sm-4" for="adr">{{ trans('page-companies.pages.fields.adr') }} : </label>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-6" for="region">{{ trans('page-companies.pages.fields.region') }} :</label>
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-6" for="mob">{{ trans('page-companies.pages.fields.mob') }} : </label>
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-6" for="land">{{ trans('page-companies.pages.fields.land') }} : </label>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-6" for="fax">{{ trans('page-companies.pages.fields.fax') }} : </label>
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-6" for="email">{{ trans('page-companies.pages.fields.email') }} : </label>
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-6" for="website">{{ trans('page-companies.pages.fields.website') }} : </label>
                ...
                <div class="modal-footer">
                    <button class="btn btn-success" type="submit" id="add">
                        <span class="fas fa-plus"></span>{{ trans('page-companies.pages.fields.save') }}
                    </button>
                    <button class="btn btn-warning" type="button" data-dismiss="modal">
                        <span class="fas fa-door-open"></span>   {{ trans('page-companies.pages.fields.exit') }}
                    </button>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="modal">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-4"for="id">{{ trans('page-companies.pages.fields.id') }} :</label>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-4" for="editcompname">{{ trans('page-companies.pages.fields.compname') }} : </label>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-4" for="editcontactperson">{{ trans('page-companies.pages.fields.contactperson') }} : </label>
                        ...
                        {{--##Address Company--}}
                        <div class="form-group">
                            <label class="control-label col-sm-4" for="editadr">{{ trans('page-companies.pages.fields.adr') }} : </label>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-6" for="editregion">{{ trans('page-companies.pages.fields.region') }} :</label>
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-6" for="editmob">{{ trans('page-companies.pages.fields.mob') }} : </label>
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-6" for="editland">{{ trans('page-companies.pages.fields.land') }} : </label>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-6" for="editfax">{{ trans('page-companies.pages.fields.fax') }} : </label>
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-6" for="editemail">{{ trans('page-companies.pages.fields.email') }} : </label>
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-6" for="editwebsite">{{ trans('page-companies.pages.fields.website') }} : </label>
