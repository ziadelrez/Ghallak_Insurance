...
@section('content')
    ...
    <div class="container-fluid">
        <form class="needs-validation" novalidate method="POST" action="{{ route('clients.update.maids',$maidsdetails[0]->id)}}">
            {{--                {{ csrf_field() }}--}}
            <input id="clientid" type="hidden" name="clientid" value="{{$maidsdetails[0]->client}}">
            @csrf
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">{{ trans('page-client.clients.titlecardmaidedit') }} - {{$clientname[0]->cname}}</strong>
                        </div>
                        <div class="card-body">
                            {{--##Maid Full Name--}}
                            <div class="form-group has-success">
                                ...
                                <input id="maidname" name="maidname" type="text"
                                       class="form-control maidname valid" value="{{$maidsdetails[0]->maidname}}" required>
                            ...
                            <div class="form-group has-success">
                                ...
                                <input id="dob" name="dob" type="date"
                                       ...
                                       value="{{$maidsdetails[0]->dob}}" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group" data-label="1">
                                ...
                                <select id="natio" name="natio" class="form-control p selectionnatio"
                                    ...
                                    @foreach($natio as $natiolist)
                                        @if($natiolist -> id == $maidsdetails[0]->natio)
                                            <option selected
                            ...
                            <div class="form-group has-success">
                                ...
                                <input id="passport" name="passport" class="form-control passport valid" type="text"
                                      value="{{$maidsdetails[0]->passport}}" required>
                                <div class="invalid-feedback">
...
@push('js_content')
    <script src={{ asset('adminassets/js/custom/updatemaid.js') }}></script>
