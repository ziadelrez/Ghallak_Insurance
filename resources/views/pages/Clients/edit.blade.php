...
{{--                                </ul>--}}
            ...
            @endif
        <div class="container">
            <form class="row g-3 needs-validation" novalidate method="POST" action="{{ route('clients.update',$clientdetails[0]->id)}}" >
{{--                    @method('PUT')--}}
                    @csrf
                <div class="row">
                    <div class="col-lg-6">
                            ...
                            <div class="card-body">
                                <div class="form-group has-success">
                                    ...
                                    <input id="sigil" name="sigil" type="text"
                                           class="form-control fname valid" value="{{$clientdetails[0]->sigil}}" required>
{{--                                    @error('sigil')--}}
...
{{--                                            @enderror--}}
                                ...
                                <div class="form-group has-success">
                                    ...
                                    <input id="passnum" name="passnum" type="text"
                                           class="form-control fname valid" value="{{$clientdetails[0]->passnum}}">
                                    @error('passnum')
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="form-group has-success">
                                            ...
                                            <input id="passdate" name="passdate" type="date"
                                                   ...
                                                   value="{{$clientdetails[0]->passdate}}" required>
{{--                                            @error('passdate')--}}
