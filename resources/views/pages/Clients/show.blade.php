...
@section('title')
    {{ trans('page-client.clients.showtitle') }}
@endsection
                                ...
                                <div class="col-md-4 col-sm-12 col-xs-12">
                                    <div class="form-group has-success">
                                        <input name="office" id="office" type="checkbox"
                                               ...
                                               @endif;
                                               onchange="onCheckboxChangedOffice(this.checked)" class="switchery" disabled>
                                ...
                                <div class="col-md-4 col-sm-12 col-xs-12">
                                    <div class="form-group ">
                                        <input id="officeshare" name="officeshare" type="text"
                                               class="form-control officeshare valid" value="{{$clientdetails[0]->officeshare}}" style="display:none;" disabled>
                                    </div>
                                </div>
                            </div>
                            {{--##Garage & Broker--}}
                                ...
                                <div class="col-md-4 col-sm-12 col-xs-12">
                                    <div class="form-group has-success">
                                        <input name="broker" id="broker" type="checkbox"
                                               ...
                                               @endif;
                                               onchange="onCheckboxChangedBroker(this.checked)" class="switchery" disabled>
                                ...
                                <div class="col-md-4 col-sm-12 col-xs-12">
                                    <div class="form-group ">
                                        <input id="brokershare" name="brokershare" type="text"
                                               class="form-control brokershare valid" value="{{$clientdetails[0]->brokershare}}" style="display:none;" disabled>
                                    </div>
                                </div>
                            </div>
                            {{--##Expert & Employee--}}
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input id="cmob" name="cmob" class="form-control"
                                               ...
                                               disabled value="{{$clientdetails[0]->cmob}}"/>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input id="cland" name="cland" class="form-control"
                                               ...
                                               disabled value="{{$clientdetails[0]->cland}}"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group has-success">
                                        ...
                                        <input id="email" name="email" class="form-control"
                                               ...
                                               disabled value="{{$clientdetails[0]->email}}"/>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control " type="text" name="name" id="name" value="{{ $getusersinfo[0]->name }}" disabled>
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control " type="text" name="username" id="username" value="{{ $getusersinfo[0]->email }}" disabled>
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control " type="text" name="password" id="password" value="{{ $clientdetails[0]->pid }}" disabled>
                                <div class="invalid-feedback">
