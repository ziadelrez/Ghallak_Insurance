...
@section('content')
    ...
    <div class="content mt-3">
        <div class="animated fadeIn">
            ...
            @endif
                <div class="container">
                    <form class="row g-3 needs-validation" novalidate method="POST" action="{{ route('cars.update',$carsdetails[0]->id)}}" enctype="multipart/form-data">
                        {{--                {{ csrf_field() }}--}}
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <strong class="card-title">{{trans('page-cars.cars.upcar')}}</strong>
                                    </div>
                                                ...
                                                <div class="form-group" data-label="5">
                                                    ...
                                                    <select id="carenginetype" name="carenginetype" class="form-control p selectioncarenginetype"
                                                        ...
                                                        @foreach($carenginelist as $enginelist)
                                                            @if($enginelist -> id == $carsdetails[0]->enginetype)
                                                                <option selected
                                                                        value="{{$enginelist -> id}}">{{$enginelist -> Description}}</option>
                                                            @else
                                                                <option
                                                                    value="{{$enginelist -> id}}">{{$enginelist -> Description}}</option>
                                                            @endif
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group" data-label="6">
                                                    ...
                                                    <select class="form-control-select p select2 {{ $errors->has('carsspecs') ? 'is-invalid' : '' }}" name="carsspecs[]" id="carsspecs" multiple required aria-required="true" aria-invalid="false">
                                                        @foreach($carspecslist as $carspecs)
                                                            <option value="{{ $carspecs -> id }}" {{ (in_array($carspecs -> id, old('carsspecs', [])) || $slist2->contains($carspecs -> id)) ? 'selected' : '' }}>{{ $carspecs -> Description }}</option>
                                                        @endforeach
                                                    </select>
{{--                                                    @error('carsspecs')--}}
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group has-success">
                                            ...
                                            <input id="carused" name="carused" type="date"
                                                   ...
                                                   value="{{$carsdetails[0]->carused}}" required>
{{--                                            @error('carused')--}}
...
{{--                                            @enderror--}}
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <br>
                                                <div class="form-group has-success">
                                                    <input name="carstop" id="carstop" type="checkbox"
                                                           @if(isset($carsdetails[0]->carstop))
                                                           {!!  $carsdetails[0]->carstop ? "checked" : ""!!}
                                                           @endif;
                                                           class="switchery">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <div class="form-group has-success">
                                                    ...
                                                    <input id="stopdate" name="stopdate" type="date"
                                                           ...
                                                           value="{{$carsdetails[0]->stopdate}}" required>
{{--                                                    @error('stopdate')--}}
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <div class="form-group has-success">
                                                    ...
                                                    <input id="bags" name="bags" type="number"
                                                           class="form-control bags valid" value="{{$carsdetails[0]->bags}}" required>
                                                    <span class="help-block field-validation-valid" data-valmsg-for="cc-name"
                                                          data-valmsg-replace="true"></span>
{{--                                                    @error('bags')--}}
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <div class="form-group has-success">
                                                    ...
                                                    <input id="doors" name="doors" type="number"
                                                           class="form-control doors valid" value="{{$carsdetails[0]->doors}}" required>
                                                    <span class="help-block field-validation-valid" data-valmsg-for="cc-name"
                                                          data-valmsg-replace="true"></span>
{{--                                                    @error('doors')--}}
                                                ...
                                                <div class="form-group" data-label="7">
                                                    ...
                                                    <select id="transmission" name="transmission" class="form-control p "
                                                        ...
                                                        @foreach($cartransmissionlist as $transmission)
                                                            @if($transmission -> id == $carsdetails[0]->transmission)
                                                                <option selected
                                                                        value="{{$transmission -> id}}">{{$transmission -> Description}}</option>
                                                            @else
                                                                <option
                                                                    value="{{$transmission -> id}}">{{$transmission -> Description}}</option>
                                                            @endif
                                            ...
                                            <div class="row">
                                                <div class="col-md-9 col-sm-9 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" class="form-control" name="photo"  id="photo" value="{{$carsdetails[0]->img_filename}}" >
                                                    </div>
                                                </div>
{{--                                                @error('photo')--}}
...
{{--                                                @enderror--}}
                                                ...
                                                <div class="col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-group">
                                                        <img id="blah" src="/files/cars/{{$carsdetails[0]->id}}/{{$carsdetails[0]->img_filename}}" style="width: 100px; height: 100px;" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                    ...
                                                    <select id="branch" name="branch" class="form-control p"
                                                        ...
                                                        @foreach($branchlist as $brlist)
                                                            @if($brlist -> id == $carsdetails[0]->branch)
                                                                <option selected
...
@push('js_content')
    ...
    <script src={{ asset('adminassets/js/custom/upcar.js') }}></script>
