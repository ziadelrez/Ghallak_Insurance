...
@section('content')
    ...
    <div class="content mt-3">
        <div class="container">
                <form class="needs-validation" novalidate method="POST" action="{{ route("cars.store") }}" enctype="multipart/form-data">
                    {{--                {{ csrf_field() }}--}}
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title">{{trans('page-cars.cars.newcar')}} - {{$clname}} </strong>
                                </div>

                                <div class="card-body">
                                    {{--##Car name & Car Plat Number & Engine Type--}}
                                    <div class="row">
                                            ...
                                            <div class="form-group" data-label="6">
                                                ...
                                                <select id="enginetype" name="enginetype" class="form-control p selectionenginetype"
                                                    ...
                                                    @foreach($carsenginetypelist as $engtypelist)
                                                        <option value="{{$engtypelist -> id}}">{{$engtypelist -> Description}}</option>
                                                    @endforeach
                                                </select>
                                                <div class="invalid-feedback">
...
{{--                                                @enderror--}}
                                            ...
                                            <div class="form-group" data-label="5">
                                                ...
                                                <select id="carsuses" name="carsuses" class="form-control p selectioncarsuses"
                                                    ...
                                                    @foreach($carsuselist as $carulist)
                                                        <option value="{{$carulist -> id}}">{{$carulist -> Description}}</option>
                                                    @endforeach
                                                </select>
                                                <div class="invalid-feedback">
                                                    {{trans('validation.cars.carenginetype_required')}}
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <a class="btn btn-danger btn-block" href=" {{ route("clients.showcars",$clid) }}">
                                                    {{ trans('global.cancel') }}
                                                </a>
                                            </div>
                                        </div>
