                            ...
                            @foreach($licensedetails as $lilist)
                                <tr class="lirows{{$lilist -> liid}}">
                                    ...
                                    <td class="text-center">
                                        <button class="edit-modal btn btn-warning btn-sm" data-id="{{$lilist->liid}}" data-title="{{$lilist->drivername}}" >
                                            <i class="fa fa-edit"></i>
                                        </button>

                                        <button class="delete-modal btn btn-danger btn-sm" data-id="{{$lilist->liid}}" data-title="{{$lilist->drivername}}" >
