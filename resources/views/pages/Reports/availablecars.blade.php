...
@section('title')
    {{ trans('reports.Reports.titleavailablecars') }}
@endsection
                            ...
                            <div class="col-lg-12 col-sm-12 col-xs-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong class="card-title">{{trans('reports.Reports.exptitlecard')}}</strong>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered" id="bootstrap-data-table"  cellspacing="0">
                                                <thead>
                                                <tr>
                                                    <th class="text-center align-middle text-nowrap" >{{ trans('reports.Reports.tables.carid') }}</th>
...
{{--    <script src="{{ asset('js/daterangepicker.js') }}" type="text/javascript"></script>--}}
    ...
    <script src={{ asset('adminassets/js/custom/availablecars.js') }}></script>
