...
@section('title')
    {{ trans('reports.Reports.titletransactionscars') }}
@endsection
                            ...
                            <div class="col-lg-12 col-sm-12 col-xs-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong class="card-title">{{trans('reports.Reports.exptitlecard3')}}</strong>
                                    </div>
                                    <div class="card-body">
...
{{--    <script src="{{ asset('js/daterangepicker.js') }}" type="text/javascript"></script>--}}
    ...
    <script src={{ asset('adminassets/js/custom/transactioncars.js') }}></script>
