...
<table  style="width:100%">
        ...
        <tr style="background-color: #005490;color:#ffffff">
                    ...
                    <th >
                        <h6>{{ trans('page-accidents.tables.acchospital') }}</h6>
                    </th>
                    <th >
...
{{--            @foreach($accidentdet->relatedRecords as $relatedRecord)--}}
                <tr>
                    ...
                    <td ><p class="font-weight-bold">{{$colist -> carname}} , {{$colist -> carnumber}}</p></td>
                        <td ><p class="font-weight-bold">{{$colist -> hospitalname}}</p></td>
                    ...
                    <td ><p class="font-weight-bold">{{$colist -> hcost}}</p></td>
                    <td ><p class="font-weight-bold">{{$colist -> hcurrname}}</p></td>
                </tr>
{{--            @endforeach--}}
        @endforeach
        </tbody>
