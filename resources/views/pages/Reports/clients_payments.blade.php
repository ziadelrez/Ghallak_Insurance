...
<head>
    <title>
        {{ trans('page-contract.contract.titles.clientspaymentss') }}
    </title>
...
<table  style="width:100%">
                ...
                <div class="row" >
                    ...
                    <div class="col-md-4 text-center">
                        <div  style="text-align: center;padding: 40px 0;">
                            <h2> {{ trans('page-contract.contract.titles.clientspayments') }} </h2>
                            <h2> {{ trans('page-contract.contract.titles.clientspayments2') }} </h2>
        ...
        <tr style="background-color: #005490;color:#ffffff">
                    ...
                    <th >
                        <h6>{{ trans('page-contract.contract.tables.discount') }}</h6>
                    </th>
                    <th >
                        <h6>{{ trans('page-contract.contract.tables.dueamount') }}</h6>
                    </th>
                    <th style="width:30%">
        ...
        @foreach($paymentlist as $colist)
            <tr>
                ...
                <td ><p class="font-weight-bold">{{number_format($colist -> discount)}} {{$colist -> paycurr}}</p></td>
                <td ><p class="font-weight-bold">{{number_format($colist -> dueamount)}} {{$colist -> paycurr}}</p></td>
