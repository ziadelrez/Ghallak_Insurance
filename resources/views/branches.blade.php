                ...
                <div class="row">
                    <div class="col-xs-12 col-lg-offset-1 col-lg-10">
                        <div class="page-title text-center">
                            <h2>Our <span class="primary">Branches</span> <span class="title-bg">Branches</span></h2>
                            <p>Please Visit One of Our Branches in Order to See and Check in Place Our Cars Collections.</p>
                        </div>
                        ...
                        <div class="hexagon-menu services clear">
                            <div class="service-hex">
                                ...
                                <div class="content">
                                    ...
                                    <h4>Najib Rent A Car<br> Halba</h4>
                                    <p>Main Branch</p>
                                </div>
                            </div>
                            <div class="service-hex">
                                ...
                                <div class="content">
                                    ...
                                    <h4>Najib Rent A Car<br> Tripoli</h4>
                                    <p>Second Branch</p>
                                </div>
                            </div>
